...
func (wrapper *videoWrapper) Call(ctx context.Context, req client.Request, resp interface{}, opts ...client.CallOption) error {
...
func NewVideoWrapper(c client.Client) client.Client {
	return &videoWrapper{c}
}
