...
func (wrapper *commentWrapper) Call(ctx context.Context, req client.Request, resp interface{}, opts ...client.CallOption) error {
...
func NewCommentWrapper(c client.Client) client.Client {
	return &commentWrapper{c}
}
