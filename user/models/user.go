...
type User struct {
	...
	FollowCount   int64  `json:"follow_count"   gorm:"column:follow_count; type:INT NOT NULL DEFAULT 0 "`
	FollowerCount int64  `json:"follower_count" gorm:"column:follower_count; type:INT NOT NULL DEFAULT 0"`
